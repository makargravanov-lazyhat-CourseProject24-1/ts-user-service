...
object Users:  LongIdTable(name = "users") {
    ...
    val passportSeries = char("passport_series", 4).nullable().clientDefault { null }.uniqueIndex("passport")
    val passportNumber = char("passport_number", 6).nullable().clientDefault { null }.uniqueIndex("passport")
